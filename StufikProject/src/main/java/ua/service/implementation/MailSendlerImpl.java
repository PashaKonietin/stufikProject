...
@Service
public class MailSendlerImpl implements MailSender{
 
    private final static String USERNAME = "stuficproject@gmail.com";
    private final static String PASSWORD = "95162847337pasha";
